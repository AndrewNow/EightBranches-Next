export default {
  ...
  fields: [
    {
      name: "facultyInstructorData",
      title: "Faculty entries (Instructor)",
      type: "array",
      of: [
        {
          title: "Faculty Instructor entry",
          name: "facultyInstructorEntry",
          type: "object",
          fields: [
            {
              name: "title",
  ...
  preview: {
    prepare() {
      return {
        title: 'Edit, add and remove faculty instructors here',
      }
    },
  },
};
